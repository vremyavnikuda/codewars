...
// Функция для добавления всех элементов списка L2 после первого вхождения
// элемента E в список L1
...
int main() {
    ...
    if (maxNode != NULL) {
        std::cout << "Максимальный элемент списка L1: " << maxNode->value
                  << std::endl;
    }
    ...
    std::cout << "Длина нового списка L1 после добавления элементов списка L2: "
              << new_length << std::endl;
    Print_list(L1);
