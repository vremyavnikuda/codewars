/*
oВнутри функции main (объявлять функцию не нужно) необходимо написать программу:
...
func main() {
	...
	for i := 0; i < 3; i++ {
		var index_1, index_2 int
		fmt.Scan(&index_1, &index_2)
		workArray[index_1], workArray[index_2] = workArray[index_2], workArray[index_1]
	}
	for i, volue := range workArray {
		if i > 0 {
			fmt.Print(" ")
		}
		fmt.Print(volue)
